...
<div class="tabview">
    <ul class="tab-links">
        ...
        <li>
            <a href=".tab-2"><?= \Framework\Localization\Localization::$lang[16]['Address'] ?></a>
        <li>
            <a href=".tab-3"><?= \Framework\Localization\Localization::$lang[16]['Terms'] ?></a>
        <li>
            <a href=".tab-4"><?= \Framework\Localization\Localization::$lang[16]['Discount'] ?></a>
    </ul>
    ...
    <div class="tab-content">
        <div class="tab tab-1 active">
			<div class="b b-2 c1-8 c1" id="i1-8-2">
			    <h1>
			        <?= \Framework\Localization\Localization::$lang[16]['Account']; ?>
			    ...
			    <div class="bc-1">
			        <form class="f-1">
			            <ul class="l-1">
			            	<li>
			                    <label for="i-status"><?= \Framework\Localization\Localization::$lang[16]['Reference']; ?></label>
			                <li>
			                    <input type="text"> <button><?= \Framework\Localization\Localization::$lang[0]['Find']; ?></button>
			                <li>
			                    <label for="i-status"><?= \Framework\Localization\Localization::$lang[16]['Status']; ?></label>
			                <li>
			                    <select name="status" id="i-status">
			                        <option value="0">
			                            <?= \Framework\Localization\Localization::$lang[16]['Active']; ?>
			                        <option value="1">
			                            <?= \Framework\Localization\Localization::$lang[16]['Inactive']; ?>
			                    </select>
			                <li>
			                    <label for="i-type"><?= \Framework\Localization\Localization::$lang[16]['Type']; ?></label>
			                <li>
			                    <select name="type" id="i-type">
			                        <option value="0">
			                            <?= \Framework\Localization\Localization::$lang[16]['Single']; ?>
			                        <option value="1">
			                            <?= \Framework\Localization\Localization::$lang[16]['Group']; ?>
			                    </select>
			                <li>
			                    <label for="i-active"><?= \Framework\Localization\Localization::$lang[16]['Activity']; ?></label>
			                <li>
			...
			<div class="b b-2 c1-8 c1" id="i1-8-3">
			    ...
			    <div class="bc-1">
			        <form class="f-1">
			            <ul class="l-1">
			                <li>
			                    <label for="i-login"><?= \Framework\Localization\Localization::$lang[16]['Loginname']; ?></label>
			                <li>
			                    <input name="login" class="i-1 t-i" id="i-login" type="text">
			                <li>
			                    <label for="i-name1"><?= \Framework\Localization\Localization::$lang[16]['Name1']; ?></label>
			                <li>
			                    <input name="name1" class="i-1 t-i" id="i-name1" type="text">
			                <li>
			                    <label for="i-name2"><?= \Framework\Localization\Localization::$lang[16]['Name2']; ?></label>
			                <li>
			                    <input name="name2" class="i-1 t-i" id="i-name2" type="text">
			                <li>
			                    <label for="i-name3"><?= \Framework\Localization\Localization::$lang[16]['Name3']; ?></label>
			                <li>
                ...
                <div class="bc-1">
                    <form class="f-1">
                        <ul class="l-1">
                            ...
                            <li>
                                <label
                                    for="i-status"><?= \Framework\Localization\Localization::$lang[16]['IsDefault']; ?></label>
                            <li>
                                <input type="checkbox"><label for="i-status"><?= \Framework\Localization\Localization::$lang[16]['IsDefault']; ?></label>
                            <li>
                                <label
		...
		<div class="tab tab-3">
			<div class="b b-1 c16-1 c16" id="i16-1-1">
                <h1>
                    <?= \Framework\Localization\Localization::$lang[16]['Payment']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
		...
		<div class="tab tab-4">
			<div class="b b-1 c16-1 c16" id="i16-1-1">
                <h1>
                    <?= \Framework\Localization\Localization::$lang[16]['Discount']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
                ...
                <div class="bc-1">
                    <form class="f-1">
                        <ul class="l-1">
                            ...
                            <li>
                                <label
                                    for="i-status"><?= \Framework\Localization\Localization::$lang[16]['Discount']; ?></label>
                            <li>
                                <input type="text">
                            <li>
                                <label
                                    for="i-status"><?= \Framework\Localization\Localization::$lang[16]['DiscountP']; ?></label>
                            <li>
                                <input type="text">
                            <li>
                            	<input type="button" value="<?= \Framework\Localization\Localization::$lang[0]['Add']; ?>">
