        ...
        <div class="bc-1">
            <form class="f-1">
                <ul class="l-1">
                    ...
                    <li>
                        <input type="text">
                        <button><?= \Framework\Localization\Localization::$lang[0]['Find']; ?></button>
                    <li>
                    ...
                    <li>
                        <label
                            for="i-active"><?= \Framework\Localization\Localization::$lang[16]['Activity']; ?></label>
                    <li>
        ...
        <div class="bc-1">
            <form class="f-1">
                <ul class="l-1">
                    <li>
                        <label
                            for="i-login"><?= \Framework\Localization\Localization::$lang[16]['Loginname']; ?></label>
                    <li>
