<?php /** @var \Modules\Warehousing\Handler $this */
    ...
    <table class="t t-1 c27-1 c27" id="i27-1-1">
        ...
        <tr>
            <th colspan="9" class="lT">
                ...
                <h1><?= \Framework\Localization\Localization::$lang[27]['Arrivals']; ?></h1>
            <th class="rT">
        ...
        <tr>
            ...
            \Framework\Model\Model::generate_table_header_view(
                [
                    ...
                    ['name' => \Framework\Localization\Localization::$lang[27]['Consignor'], 'sort' => 0],
