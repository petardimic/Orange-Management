    ...
    <table class="t-1 c1-2 c1 full" id="i1-2-1">
        ...
        <tr>
            <th colspan="3" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['Departments'] ?></h1>
            <th class="rT">
    ...
    <table class="t-1 c1-2 c1 full" id="i1-2-1">
        ...
        <tr>
            <th colspan="3" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['Categories'] ?></h1>
            <th class="rT">
                <i class="fa fa-minus min"></i>
                <i class="fa fa-plus max vh"></i>
                <tr>
    ...
    <table class="t-1 c1-2 c1 full" id="i1-2-1">
        ...
        <tr>
            <th colspan="3" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['Units'] ?></h1>
            <th class="rT">
                <i class="fa fa-minus min"></i>
                <i class="fa fa-plus max vh"></i>
                <tr>
    ...
    <table class="t-1 c1-2 c1 full" id="i1-2-1">
        ...
        <tr>
            <th colspan="3" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['RiskLevels'] ?></h1>
            <th class="rT">
                <i class="fa fa-minus min"></i>
                <i class="fa fa-plus max vh"></i>
                <tr>
                    ...
                    \phpOMS\Model\Model::generate_table_header_view(
                        [
                            ...
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[0]['ID'], 'sort' => 1],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['Name'], 'sort' => 0, 'full' => true],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['Severity'], 'sort' => 0],
                        ]
                    );
                    ?>
        <tbody>
    ...
    <table class="t-1 c1-2 c1 full" id="i1-2-1">
        ...
        <tr>
            <th colspan="3" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[30]['RiskProbabilities'] ?></h1>
            <th class="rT">
                <i class="fa fa-minus min"></i>
                <i class="fa fa-plus max vh"></i>
                <tr>
