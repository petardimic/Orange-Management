...
<table class="t t-1 c1-2 c1" id="i1-2-1">
    ...
    <tr>
        <th colspan="4" class="lT">
            ...
            <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang[42]['EventManagement'] ?></h1>
        <th class="rT">
    ...
    <tr>
        ...
        \phpOMS\Model\Model::generate_table_header_view(
            [
                ...
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[42]['Title'], 'sort' => 0, 'full' => true],
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[42]['Status'], 'sort' => 0],
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[42]['Start'], 'sort' => 0],
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[42]['End'], 'sort' => 0],
            ]
        );
        ?>
        <tbody>
