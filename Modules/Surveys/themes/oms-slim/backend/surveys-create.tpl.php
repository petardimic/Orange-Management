...
\Framework\Module\ModuleFactory::$loaded['Navigation']->callWeb([\Modules\Navigation\NavigationType::CONTENT, 1000801001]);
    ...
    <div class="tab-content">
        <div class="tab tab-1 active">
            <div class="b b-2 c8-2 c8" id="i8-2-1">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Survey']; ?>
            ...
            <div class="b b-2 c8-2 c8" id="i8-2-2">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Permissions']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
        ...
        <div class="tab tab-2">
            <div class="b b-2 c8-2 c8" id="i8-2-1">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Section']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
        ...
        <div class="tab tab-3">
            <div class="b b-2 c8-2 c8" id="i8-2-1">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Question']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
        ...
        <div class="tab tab-4">
            <div class="b b-2 c8-2 c8" id="i8-2-1">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Answer']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
                    ...
                    <ul class="l-1">
                        ...
                        <li>
                            <select>
                                ...
                                <option><?= $this->app->user->localization->lang[8]['Checkbox']; ?>
                                <option><?= $this->app->user->localization->lang[8]['Dropdown']; ?>
                                <option><?= $this->app->user->localization->lang[8]['Text']; ?>
            ...
            <div class="b b-2 c8-2 c8" id="i8-2-1">
                <h1>
                    <?= $this->app->user->localization->lang[8]['Additional']; ?>
                    <i class="fa fa-minus min"></i>
                    <i class="fa fa-plus max vh"></i>
                </h1>
