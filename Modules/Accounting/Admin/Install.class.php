                ...
                case \Framework\DataStorage\Database\DatabaseType::MYSQL:
                    ...
                    $db->con->prepare(
                        'ALTER TABLE `' . $db->prefix . 'accounting_invoices_status`
                            ADD CONSTRAINT `accounting_invoices_status_ibfk_1` FOREIGN KEY (`invoice`) REFERENCES `' . $db->prefix . 'accounting_invoices_process` (`AccountingInvoiceProcessID`),
                            ADD CONSTRAINT `accounting_invoices_status_ibfk_2` FOREIGN KEY (`person`) REFERENCES `' . $db->prefix . 'accounts` (`id`);'
                    )->execute();
                    ...
                    $db->con->prepare(
                        'ALTER TABLE `' . $db->prefix . 'accounting_invoices_process_permission`
                            ADD CONSTRAINT `accounting_invoices_process_permission_ibfk_1` FOREIGN KEY (`person`) REFERENCES `' . $db->prefix . 'accounts` (`id`),
                            ADD CONSTRAINT `accounting_invoices_process_permission_ibfk_2` FOREIGN KEY (`process`) REFERENCES `' . $db->prefix . 'accounting_invoices_process` (`AccountingInvoiceProcessID`);'
                    )->execute();
                    break;
            }
