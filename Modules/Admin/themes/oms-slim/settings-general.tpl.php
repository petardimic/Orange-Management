            ...
            <ul class="l-1">
                ...
                <li>
                    <input name="oname" class="i-1 t-ts" id="i-on" type="text"
                           value="<?= \Framework\Core\Model::$content['core:oname']; ?>">
                    <i class="bt-1 p-3 vh">
                ...
                <li>
                    <input name="addrlocal" class="i-1 t-ip t-wp" id="i-loc" type="text"
                           value="<?= \Framework\Core\Model::$content['page:addr:local']; ?>">
                    <i class="bt-1 p-3 vh">
                ...
                <li>
                    <input name="addrremote" class="i-1 t-ip t-wp" id="i-rem" type="text"
                           value="<?= \Framework\Core\Model::$content['page:addr:remote']; ?>">
                    <i class="bt-1 p-3 vh">
            ...
            <ul class="l-1">
                ...
                <li>
                    <select name="lang" class="i-1" id="i-lang">
                        ...
                        foreach ($GLOBALS['LANGUAGES_ARRAY'] as $key => $val) {
                            echo '<option value="' . $key . '"' . ($key === \Framework\Core\Model::$content['core:language'] ? ' selected' : '') . '>' . $val . '</option>';
                        }
                        ?>
                    </select>
                </li>
                ...
                <li>
                    <select name="time" class="i-1" id="i-time">
                        ...
                        foreach ($GLOBALS['TIMEZONES_ARRAY'] as $key => $val) {
                            echo '<option value="' . $val . '"' . ($val === \Framework\Core\Model::$content['core:timezone'] ? ' selected' : '') . '>' . $val . '</option>';
                        }
                        ?>
                    </select>
                </li>
                ...
                <li>
                    <input name="timeformat" class="i-1 t-timef" id="i-timef" type="text"
                           value="<?= \Framework\Core\Model::$content['core:timeformat']; ?>">
                    <i class="bt-1 p-3 vh">
