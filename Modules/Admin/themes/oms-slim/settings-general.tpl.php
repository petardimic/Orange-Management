                ...
                <li>
                    <select name="lang" class="i-1" id="i-lang">
                        ...
                        foreach ($locals['LANGUAGES_ARRAY'] as $key => $val) {
                            echo '<option value="' . $key . '"' . ($key === $this->app->settings->config[1000000020] ? ' selected' : '') . '>' . $val . '</option>';
                        }
                        ?>
                    </select>
                </li>
                ...
                <li>
                    <select name="time" class="i-1" id="i-time">
                        ...
                        foreach ($locals['TIMEZONES_ARRAY'] as $key => $val) {
                            echo '<option value="' . $val . '"' . ($val === $this->app->settings->config[1000000021] ? ' selected' : '') . '>' . $val . '</option>';
                        }
                        ?>
                    </select>
                </li>
